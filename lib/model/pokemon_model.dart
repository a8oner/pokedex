...
//
//     final pokemonCevap = pokemonCevapFromJson(jsonString);

import 'dart:convert';

PokemonModel pokemonCevapFromJson(String str) => PokemonModel.fromJson(json.decode(str));

String pokemonCevapToJson(PokemonModel data) => json.encode(data.toJson());
